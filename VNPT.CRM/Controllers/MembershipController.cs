...
namespace VNPT.CRM.Controllers
{
    public class MembershipController : BaseController
    {
        ...
        public MembershipController(IHostingEnvironment hostingEnvironment, IMembershipRepository membershipRepository, IMembershipPropertyRepository membershipPropertyRepository, IInvoiceRepository invoiceRepository, IInvoicePropertyRepository invoicePropertyRepository, IConfigRepository configResposistory) : base()
        {
                                                        ...
                                                        if (model != null)
                                                        {
                                                            ...
                                                            if (membershipProperty == null)
                                                            {
                                                                ...
                                                                if (workSheet.Cells[i, 3].Value != null)
                                                                {
                                                                    try
                                                                    {
                                                                        membershipProperty.ValueContract = decimal.Parse(workSheet.Cells[i, 3].Value.ToString().Trim());
                                                                    }
                                                                    catch
                                                                    {
                                                                    }
                                                            ...
                                                            if (membershipProperty != null)
                                                            {
                                                                ...
                                                                if (invoice == null)
                                                                {
                                                                    ...
                                                                    invoice.Total = membershipProperty.ValueContract;
                                                                ...
                                                                if (invoice != null)
                                                                {
                                                                    ...
                                                                    invoiceProperty.UnitPrice = membershipProperty.ValueContract;
